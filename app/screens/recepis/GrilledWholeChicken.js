...
const GrilledWholeChicken = ({navigation}) => {
  //Firebase Firestore
  const [ loading, setLoading ] = useState(true);
  const [recepi, setRecepi] = useState([]);
  const ref = firebase.firestore().collection('GrilledWholeChicken').get();

  useEffect(() => {
      const showRecepis = firebase.firestore()
          .collection('GrilledWholeChicken')
                ...
                <View>
                    ...
                    <View style={RecepiStyle.section}>
                        ...
                        <View>
                            ...
                            <View style={RecepiStyle.sectionIngredients}>
                                <Icon style={RecepiStyle.iconIngredients} name="ellipse" size={10}/>
                                <Text style={RecepiStyle.textIngredients}>{item.ingredient4}</Text>
                            </View>
                            <View style={RecepiStyle.sectionIngredients}>
                                <Icon style={RecepiStyle.iconIngredients} name="ellipse" size={10}/>
                                <Text style={RecepiStyle.textIngredients}>{item.ingredient5}</Text>
                            </View>
                            <View style={RecepiStyle.sectionIngredients}>
                                <Icon style={RecepiStyle.iconIngredients} name="ellipse" size={10}/>
                                <Text style={RecepiStyle.textIngredients}>{item.ingredient6}</Text>
                            </View>
                            <View style={RecepiStyle.sectionIngredients}>
                                <Icon style={RecepiStyle.iconIngredients} name="ellipse" size={10}/>
                                <Text style={RecepiStyle.textIngredients}>{item.ingredient7}</Text>
                            </View>
                            <View style={RecepiStyle.sectionIngredients}>
                                <Text style={RecepiStyle.textIngredients}>{item.subtitleIngredient1}</Text>
                            </View>
                            <View style={RecepiStyle.sectionIngredients}>
                                <Icon style={RecepiStyle.iconIngredients} name="ellipse" size={10}/>
                                <Text style={RecepiStyle.textIngredients}>{item.ingredient8}</Text>
                            </View>
                            <View style={RecepiStyle.sectionIngredients}>
                                <Icon style={RecepiStyle.iconIngredients} name="ellipse" size={10}/>
                                <Text style={RecepiStyle.textIngredients}>{item.ingredient9}</Text>
                            </View>
                            <View style={RecepiStyle.sectionIngredients}>
                                <Icon style={RecepiStyle.iconIngredients} name="ellipse" size={10}/>
                                <Text style={RecepiStyle.textIngredients}>{item.ingredient10}</Text>
                            </View>
                            <View style={RecepiStyle.sectionIngredients}>
                                <Icon style={RecepiStyle.iconIngredients} name="ellipse" size={10}/>
                                <Text style={RecepiStyle.textIngredients}>{item.ingredient11}</Text>
                            </View>
                            <View style={RecepiStyle.sectionIngredients}>
                                <Icon style={RecepiStyle.iconIngredients} name="ellipse" size={10}/>
                                <Text style={RecepiStyle.textIngredients}>{item.ingredient12}</Text>
                            </View>
                            <View style={RecepiStyle.sectionIngredients}>
                                <Icon style={RecepiStyle.iconIngredients} name="ellipse" size={10}/>
                                <Text style={RecepiStyle.textIngredients}>{item.ingredient13}</Text>
                            </View>
                            <View style={RecepiStyle.sectionIngredients}>
                                <Icon style={RecepiStyle.iconIngredients} name="ellipse" size={10}/>
                                <Text style={RecepiStyle.textIngredients}>{item.ingredient14}</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={[RecepiStyle.section, {marginVertical: 32} ]}>
                        ...
                        <View>
                            ...
                            />
                            <List.Item
                                title={item.subtitlePreparation4}
                                description={item.preparation4}
                                descriptionNumberOfLines= {20}
                                titleStyle={{color: "#B85C38"}}
                                descriptionStyle={{color: "#E0C097"}}
                            />
                            <List.Item
                                title={item.subtitlePreparation5}
                                description={item.preparation5}
                                descriptionNumberOfLines= {20}
                                titleStyle={{color: "#B85C38"}}
                                descriptionStyle={{color: "#E0C097"}}
                            />
                            <List.Item
                                title={item.subtitlePreparation6}
                                description={item.preparation6}
                                descriptionNumberOfLines= {20}
                                titleStyle={{color: "#B85C38"}}
                                descriptionStyle={{color: "#E0C097"}}
                            />
                            <List.Item
                                title={item.subtitlePreparation7}
                                description={item.preparation7}
                                descriptionNumberOfLines= {20}
                                titleStyle={{color: "#B85C38"}}
                                descriptionStyle={{color: "#E0C097"}}
                            />
...
export default GrilledWholeChicken;
